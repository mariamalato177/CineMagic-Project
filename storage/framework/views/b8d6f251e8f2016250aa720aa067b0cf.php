            ...
            <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="bg-white rounded-lg overflow-hidden shadow-lg flex flex-col">
                    <div class="aspect-w-16 aspect-h-9">
                        <img src="<?php echo e($user->photoFullUrl ? $user->photoFullUrl : asset('storage/photos/no-photo-icon-22.png')); ?>" class="w-full h-full object-cover" alt="<?php echo e($user->name); ?>">
                    </div>
