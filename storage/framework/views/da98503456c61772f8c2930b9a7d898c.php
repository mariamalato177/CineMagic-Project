...
<?php $__env->startComponent('telescope-toolbar::item', ['name' => 'gates', 'link' => true]); ?>
    ...
    <?php $__env->slot('icon'); ?>
        <?php echo file_get_contents('C:\laragon\www\projeto\vendor\fruitcake\laravel-telescope-toolbar\resources\icons/' . basename('gates') . '.svg'); ?>
...
<?php echo $__env->renderComponent(); ?><?php /**PATH C:\laragon\www\projeto\vendor\fruitcake\laravel-telescope-toolbar\src/../resources/views/collectors/gates.blade.php ENDPATH**/ ?>