...
<?php $__env->startComponent('telescope-toolbar::item', ['name' => 'gates', 'link' => true]); ?>
    ...
    <?php $__env->slot('icon'); ?>
        <?php echo file_get_contents('/var/www/html/vendor/fruitcake/laravel-telescope-toolbar/resources/icons/' . basename('gates') . '.svg'); ?>
...
<?php echo $__env->renderComponent(); ?><?php /**PATH /var/www/html/vendor/fruitcake/laravel-telescope-toolbar/src/../resources/views/collectors/gates.blade.php ENDPATH**/ ?>