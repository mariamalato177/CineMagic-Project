...
<?php $__env->startComponent('telescope-toolbar::item', ['name' => 'logs ', 'link' => true, 'status' => $statusColor]); ?>
    ...
    <?php $__env->slot('icon'); ?>
        <?php echo file_get_contents('C:\laragon\www\projeto\vendor\fruitcake\laravel-telescope-toolbar\resources\icons/' . basename('logs') . '.svg'); ?>
...
<?php echo $__env->renderComponent(); ?><?php /**PATH C:\laragon\www\projeto\vendor\fruitcake\laravel-telescope-toolbar\src/../resources/views/collectors/logs.blade.php ENDPATH**/ ?>