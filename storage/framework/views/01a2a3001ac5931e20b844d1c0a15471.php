            ...
            XMLHttpRequest.prototype.open = function(method, url, async, user, pass) {
                ...
                if (url.slice(0, 1) === '/') {
                    if (0 === url.indexOf('<?php echo e(asset('/')); ?>')) {
                        path = url.slice(<?php echo e(strlen( asset('/'))); ?>);
                    }
                }
                else if (0 === url.indexOf('<?php echo e(url('/')); ?>')) {
                    path = url.slice(<?php echo e(strlen( url('/'))); ?>);
                }
...
<?php /**PATH C:\laragon\www\projeto\vendor\fruitcake\laravel-telescope-toolbar\src/../resources/views/base_js.blade.php ENDPATH**/ ?>