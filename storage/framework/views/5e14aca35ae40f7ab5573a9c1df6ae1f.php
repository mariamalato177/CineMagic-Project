...
<div <?php echo e($attributes->merge(['class' => "$widthClass"])); ?>>
    <label class="block font-medium text-sm text-gray-700 dark:text-gray-300" for="id_<?php echo e($name); ?>">
        <?php echo e($label); ?>
...
<?php /**PATH /var/www/html/resources/views/components/field/input.blade.php ENDPATH**/ ?>