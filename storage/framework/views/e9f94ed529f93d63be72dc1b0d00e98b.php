<div <?php echo e($attributes->merge(['class' => 'grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 relative z-10'])); ?>>
    <?php $__currentLoopData = $theaters; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $theater): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="bg-white  rounded-lg shadow-lg p-6 transition-transform transform hover:scale-105 flex flex-col justify-between relative z-10">
            ...
            <h3 class="text-xl font-bold text-gray-900  truncate"><?php echo e($theater->name); ?></h3>
...
<?php /**PATH /var/www/html/resources/views/components/theaters/table.blade.php ENDPATH**/ ?>