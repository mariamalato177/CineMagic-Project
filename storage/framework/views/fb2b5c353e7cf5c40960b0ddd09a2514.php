<?php $__env->startSection('header-title', 'Theater' . ' ' . $theater->name); ?>
                ...
                <div class="flex justify-center gap-2">
                    <?php $__currentLoopData = $seatsByRow; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $seat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="text-center">
                            ...
                            <h1 class="text-center" style="color:black;"><?php echo e($seat->seatName); ?></h1>
                        </div>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\projeto\resources\views/theaters/show.blade.php ENDPATH**/ ?>