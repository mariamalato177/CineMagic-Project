...
<div class="container mx-auto mt-6">
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        <?php $__currentLoopData = $occupancy->sortByDesc('occupancy_rate'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-4 transition-transform transform hover:scale-105 flex">
                ...
                <div class="w-2/3 pl-4 flex flex-col justify-between">
                    <div class="flex flex-col justify-between h-full">
                        <div class="mb-2">
                            <h3 class="text-lg font-bold text-gray-900 dark:text-gray-200"><?php echo e($item['movie']); ?></h3>
                        </div>
                        <div class="relative">
