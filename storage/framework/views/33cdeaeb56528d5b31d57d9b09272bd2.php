            ...
            <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="bg-white rounded-lg overflow-hidden shadow-lg flex flex-col">
                    <div class="aspect-w-16 aspect-h-9">
                        <img src="<?php echo e($user->photoFullUrl ? $user->photoFullUrl : asset('storage/app/public/photos/anonymous.jpg')); ?>" class="w-full h-full object-cover" alt="<?php echo e($user->name); ?>">
                    </div>
...
<?php endif; ?>
                                ...
                                <?php else: ?>
                                    <form method="POST" action="<?php echo e(route('users.unblock', ['user' => $user->id])); ?>"
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\projeto\resources\views/users/list.blade.php ENDPATH**/ ?>