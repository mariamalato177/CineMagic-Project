...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-8">
        <a href="{{ route('reports.sales_by_month') }}" class="bg-white shadow rounded-lg p-6 hover:bg-gray-100 transition duration-300 ease-in-out">
            <h2 class="text-xl font-medium text-gray-700">Sales by Month</h2>
            <p class="text-gray-500 mt-2">View monthly sales report</p>
        </a>
        <a href="{{ route('reports.occupancy_rate') }}" class="bg-white shadow rounded-lg p-6 hover:bg-gray-100 transition duration-300 ease-in-out">
